        ...
        do {
            ...
            switch (operacao) {
                case 1:
                    ...
                    // Criar o item
                    Item novoItem = new Item(0, idProduto, idKitSolar, quantidade);
                    itens.inserir(novoItem);
                    System.out.println("Item adicionado com sucesso!");

                    // Adicionar o ID do item ao kit solar
                    kitSelecionado.getIdItens().add(novoItem.getId());
                    kitsSolares.atualizar(kitSelecionado); // Atualizar o kit solar no arquivo JSON
                    break;
